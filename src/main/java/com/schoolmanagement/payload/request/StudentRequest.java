...
public class StudentRequest extends BaseUserRequest {
    ...
    @Size(min = 2, max = 16, message = "Your mother name should be between 2 and 16 chars")
    ...
    @Size(min = 2, max = 16, message = "Your father name should be between 2 and 16 chars")
